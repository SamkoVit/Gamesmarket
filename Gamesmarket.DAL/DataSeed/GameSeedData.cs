        ...
        public static List<Game> GetStarterGames()
        {
            return new List<Game>
            {
                new Game
                {
                    ...
                    GameGenres = new List<GameGenreTag>
                    {
                        new GameGenreTag { Genre = GameGenre.Strategy }
                    },
                ...
                new Game
                {
                    ...
                    GameGenres = new List<GameGenreTag>
                    {
                        new GameGenreTag { Genre = GameGenre.RPG },
                        new GameGenreTag { Genre = GameGenre.Adventure }
                    },
                ...
                new Game
                {
                    ...
                    GameGenres = new List<GameGenreTag>
                    {
                        new GameGenreTag { Genre = GameGenre.Shooter },
                        new GameGenreTag { Genre = GameGenre.Sports }
                    },
                ...
                new Game
                {
                    ...
                    GameGenres = new List<GameGenreTag>
                    {
                        new GameGenreTag { Genre = GameGenre.Action },
                        new GameGenreTag { Genre = GameGenre.Fighting }
                    },
                ...
                new Game
                {
                    ...
                    GameGenres = new List<GameGenreTag>
                    {
                        new GameGenreTag { Genre = GameGenre.Simulation },
                        new GameGenreTag { Genre = GameGenre.Horror },
                        new GameGenreTag { Genre = GameGenre.Shooter },
                        new GameGenreTag { Genre = GameGenre.Action },
                        new GameGenreTag { Genre = GameGenre.Fighting }
                    },
                ...
                new Game
                {
                    ...
                    {
                        new GameGenreTag { Genre = GameGenre.Action },
                        new GameGenreTag { Genre = GameGenre.Platformer }
                    },
